...
# Exclude combos, trackballs, and jigglers
exclude = df["title"].str.contains(
    r"keyboard|combo|trackball|jiggler|mover", case=False, na=False
)

# Apply all conditions
df = df[mice_title & mice_category & ~exclude].copy()
...
OUTPUT_FILE = "fixed_gaming_mice_clean.csv"
